...
func TestHash(t *testing.T) {
	tx := GetMockTx()
	res := tx.Hash()
	assert.Equal(t, res, common.Hash{0x4b, 0xff, 0x70, 0x1, 0xfe, 0xc4, 0x2, 0x84, 0xd9, 0x3b, 0x4c, 0x45, 0x61, 0x7d, 0xc7, 0x41, 0xb9, 0xa8, 0x8e, 0xd5, 0x9d, 0xf, 0x1, 0xa3, 0x76, 0x39, 0x4c, 0x7b, 0xfe, 0xa6, 0xed, 0x24})
}

func TestDependsOn(t *testing.T) {
	tx := GetMockTx()
	res := tx.DependsOn()
	var expected *common.Hash = nil
	assert.Equal(t, expected, res)
}

func TestTestFeatures(t *testing.T) {
	txx := GetMockTx()
	supportedFeatures := Features(1)
...
func TestTxSize(t *testing.T) {
	...
	size := tx.Size()
	assert.Equal(t, size, StorageSize(87))
}
...
func TestProvedWork(t *testing.T) {
	...
	headBlockNum := uint64(20)

	// Mock getBlockID function
	getBlockID := func(num uint64) (common.Hash, error) {
...
func TestTx(t *testing.T) {
	...
	assert.Equal(t, uint64(21000), func() uint64 { g, _ := new(Builder).Build().IntrinsicGas(); return g }())
